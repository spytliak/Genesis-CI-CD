...
def get_student(id):
    ...
    if student_info:
        ...
        return jsonify(
            message='The student with the given ID:{} is not in the database'
            .format(id)), 404
...
def modify_student(id):
    ...
    if request.method == 'PATCH':
        ...
        if student_modify:
            ...
            return jsonify(
                message='The student with the given ID:{} is not in database'
                .format(id)), 404
...
def delete_student(id):
    ...
    if request.method == 'DELETE':
        ...
        if delete_student:
            ...
            return jsonify(
                message='Student with the given ID:{} was deleted'.format(id)
                ), 200
        else:
            return jsonify(
                message='The student with the given ID:{} is not in database'
