...
output "APP_instances_ip" {
  ...
  value       = jsonencode(aws_instance.app[*].public_ip) # [for k in aws_instance.app[*] : k.public_ip]  # jsonencode(aws_instance.app[*].public_ip)
}
# replace(replace(jsonencode(aws_instance.app[*].public_ip)), "[", ""), "]", "")
#-----------------------------------------------------------------------
# RDS
#-----------------------------------------------------------------------
output "RDS_info" {
